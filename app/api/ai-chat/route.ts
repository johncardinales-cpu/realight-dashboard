...
export async function POST(request: Request) {
  try {
    ...
    const systemPrompt = [
      ...
      "Always return previews in clear sections with field labels and values. Use Unknown when not visible.",
      "For any uploaded receipt/expense document, return this exact section:",
      "EXPENSE PREVIEW",
      "- Expense Date:",
      "- Category:",
      "- Description:",
      ...
      "- Missing Fields:",
      "- Recommended Action:",
      "Receipt mode: if mode is receipt or the user typed 'receipt', classify the upload as an expense receipt unless it clearly says it is a customer invoice/receipt.",
      ...
      "For customer invoice/receipt documents, return this exact section:",
      "CUSTOMER DOCUMENT PREVIEW",
      "- Classification: Sale / Payment / Sale + Payment / Expense / Unclear",
      "- Sale Date:",
      "- Sales Ref No.:",
      "- Customer Name:",
      "- Product Lines:",
      ...
      "- Missing Fields:",
      "- Recommended Action:",
      "If a document is both a customer invoice and a receipt, classify as Sale + Payment.",
