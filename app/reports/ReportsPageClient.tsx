...
type ReportData = {
  ...
  summary: {
    ...
    currentPeriodSaleCollectionsToday?: number; priorReceivableCollectionsToday?: number; unclassifiedCollectionsToday?: number; cashReceivedToday?: number; changeGivenToday?: number; netCashAfterChangeToday?: number;
...
export default function ReportsPageClient() {
  ...
  function handleModeChange(value: Mode) {
    setMode(value);
    loadReport(date, value, true).catch(console.error);
  }

  function handleDateChange(value: string) {
    setDate(value);
    loadReport(value, mode, true).catch(console.error);
  }
